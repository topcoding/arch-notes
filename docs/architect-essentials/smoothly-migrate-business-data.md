...
* 跨DB、或从DB迁移到其它NoSQL存储场景：先写旧表，再写新表，在写失败时做好兜底重试
  ![image](./../../assets/images/https!img2024.cnblogs.com!blog!1247698!202604!1247698-20260420011643300-738699514.png)

# 2. 刷存量数据

在增量双写灰度开全后，能确保新写入的数据在新表、旧表一致，但还需要补刷历史存量数据。
离线导出全量数据的业务id，查旧表、并写新表，确保所有存量数据的新表字段都写入值。
![image](./../../assets/images/https!img2024.cnblogs.com!blog!1247698!202604!1247698-20260420011710733-406828614.png)
...
* 离线对账，参考之前写的文章：[架构师必备：实时对账与离线对账](https://www.cnblogs.com/toplist/p/19009976)
...
![image](./../../assets/images/https!img2024.cnblogs.com!blog!1247698!202604!1247698-20260420011742450-20215277.png)

# 5. 切新读

* 双读比对观察一致后，查询场景灰度切换到读新表
* 同时确保所有的离线依赖，都迁到新表数据源
  ![image](./../../assets/images/https!img2024.cnblogs.com!blog!1247698!202604!1247698-20260420011826646-2005249848.png)

# 6. 停旧写

* 在停写旧表之前，检查旧表已无在线业务方查询、无离线依赖
* 最终停写旧表
  ![image](./../../assets/images/https!img2024.cnblogs.com!blog!1247698!202604!1247698-20260420011826659-1223379922.png)
